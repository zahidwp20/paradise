...
$footer_top_space = get_theme_mod( 'paradise_htb_footer_top_space' );
...
// footer space
$footer_space = !empty( $paradise_htb_footer_top_space ) ? $paradise_htb_footer_top_space : $footer_top_space;
