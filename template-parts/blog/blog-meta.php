...
$paradise_htb_blog_date = get_theme_mod( 'paradise_htb_blog_date', true );
$paradise_htb_blog_comments = get_theme_mod( 'paradise_htb_blog_comments', true );
$paradise_htb_blog_author = get_theme_mod( 'paradise_htb_blog_author', true );
$paradise_htb_blog_cat = get_theme_mod( 'paradise_htb_blog_cat', false );

?>


<div class="postbox__meta">
    <?php if ( !empty($paradise_htb_blog_author) ): ?>
    ...
    <?php if ( !empty($paradise_htb_blog_cat) ): ?>
