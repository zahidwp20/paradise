...
// info
$paradise_htb_topbar_switch = get_theme_mod( 'paradise_htb_topbar_switch', false );
$paradise_htb_mail_id       = get_theme_mod( 'paradise_htb_mail_id', __( 'info@educal.com', 'paradise_htb' ) );
$paradise_htb_address       = get_theme_mod( 'paradise_htb_address', __( 'Moon ave, New York, 2020 NY US', 'paradise_htb' ) );
$paradise_htb_address_url   = get_theme_mod( 'paradise_htb_address_url', __( 'https://goo.gl/maps/qzqY2PAcQwUz1BYN9', 'paradise_htb' ) );

// contact button
$paradise_htb_button_text = get_theme_mod( 'paradise_htb_button_text', __( 'Contact Us', 'paradise_htb' ) );
$paradise_htb_button_link = get_theme_mod( 'paradise_htb_button_link', __( '#', 'paradise_htb' ) );

// acc button
$paradise_htb_acc_button_text = get_theme_mod( 'paradise_htb_acc_button_text', __( 'Login', 'paradise_htb' ) );
$paradise_htb_acc_button_link = get_theme_mod( 'paradise_htb_acc_button_link', __( '#', 'paradise_htb' ) );

// header right
$paradise_htb_header_right = get_theme_mod( 'paradise_htb_header_right', false );
$paradise_htb_menu_col     = $paradise_htb_header_right ? 'col-xxl-7 col-xl-7 col-lg-8 d-none d-lg-block' : 'col-xxl-10 col-xl-10 col-lg-9 d-none d-lg-block text-end';
...
?>
    ...
    <header class="d-none">
        <div class="header__area">
			<?php if ( ! empty( $paradise_htb_topbar_switch ) ): ?>
                        ...
                        <div class="row align-items-center">
                            <div class="col-xxl-6 col-xl-8 col-lg-8 col-md-8">
                                <div class="header__info">
                                    <ul>
										<?php if ( ! empty( $paradise_htb_mail_id ) ): ?>
                                            <li>
                                                <a href="mailto:<?php echo esc_attr( $paradise_htb_mail_id ); ?>">
                                                    <svg viewBox="0 0 15 13">
                                                        ...
                                                        <path d="M10.4683 11.8838V11.9838H10.5098L10.539 11.9545L10.4683 11.8838ZM12.249 11.1685L12.1785 11.0976L12.1784 11.0977L12.249 11.1685ZM2.75113 11.1685L2.8218 11.0977L2.82172 11.0976L2.75113 11.1685ZM2.11075 11.8112L2.04013 11.882L2.04017 11.8821L2.11075 11.8112ZM12.8893 11.8112L12.9599 11.8821L12.9599 11.882L12.8893 11.8112ZM4.53063 11.9838H10.4683V11.7838H4.53063V11.9838ZM10.539 11.9545C10.5246 11.969 10.5091 11.9755 10.4998 11.9786C10.4903 11.9816 10.4824 11.9826 10.4781 11.9829C10.4701 11.9836 10.464 11.983 10.464 11.983C10.4634 11.9829 10.463 11.9829 10.4634 11.9829C10.4635 11.9829 10.4646 11.9831 10.4656 11.9831C10.4673 11.9833 10.4721 11.9838 10.478 11.9838V11.7838C10.4802 11.7838 10.482 11.7839 10.483 11.7839C10.484 11.784 10.4846 11.7841 10.4847 11.7841C10.4868 11.7843 10.4818 11.7838 10.4806 11.7837C10.4787 11.7835 10.4709 11.7828 10.4615 11.7836C10.4566 11.784 10.4481 11.7851 10.4381 11.7883C10.4283 11.7915 10.4124 11.7983 10.3976 11.8131L10.539 11.9545ZM10.478 11.9838C11.1931 11.9838 11.8309 11.7274 12.3197 11.2392L12.1784 11.0977C11.7288 11.5467 11.1427 11.7838 10.478 11.7838V11.9838ZM12.3196 11.2393C12.8859 10.6756 13.1931 9.86931 13.1931 8.97418H12.9931C12.9931 9.82408 12.7018 10.5766 12.1785 11.0976L12.3196 11.2393ZM13.1931 8.97418V4.82142H12.9931V8.97418H13.1931ZM13.1931 4.82142C13.1931 3.08749 12.0538 1.80699 10.4683 1.80699V2.00699C11.9242 2.00699 12.9931 3.17775 12.9931 4.82142H13.1931ZM10.4683 1.80699H4.53184V2.00699H10.4683V1.80699ZM4.53184 1.80699C2.94632 1.80699 1.80703 3.08749 1.80703 4.82142H2.00703C2.00703 3.17775 3.07594 2.00699 4.53184 2.00699V1.80699ZM1.80703 4.82142V8.97418H2.00703V4.82142H1.80703ZM1.80703 8.97418C1.80703 9.86936 2.11492 10.6756 2.68054 11.2393L2.82172 11.0976C2.29896 10.5766 2.00703 9.82403 2.00703 8.97418H1.80703ZM2.68047 11.2392C3.16931 11.7274 3.80764 11.9838 4.52216 11.9838V11.7838C3.85808 11.7838 3.27137 11.5467 2.8218 11.0977L2.68047 11.2392ZM4.52216 11.9838H4.53063V11.7838H4.52216V11.9838ZM4.52029 12.6908C3.61295 12.6908 2.80536 12.3621 2.18133 11.7404L2.04017 11.8821C2.70284 12.5422 3.56168 12.8908 4.52029 12.8908V12.6908ZM2.18137 11.7404C1.48568 11.0465 1.1 10.0656 1.1 8.97418H0.9C0.9 10.1127 1.30279 11.1465 2.04013 11.882L2.18137 11.7404ZM1.1 8.97418V4.82141H0.9V8.97418H1.1ZM1.1 4.82141C1.1 2.69051 2.58079 1.1 4.53178 1.1V0.9C2.45578 0.9 0.9 2.59518 0.9 4.82141H1.1ZM4.53178 1.1H10.4683V0.9H4.53178V1.1ZM10.4683 1.1C12.4193 1.1 13.9001 2.69051 13.9001 4.82141H14.1001C14.1001 2.59518 12.5443 0.9 10.4683 0.9V1.1ZM13.9001 4.82141V8.97418H14.1001V4.82141H13.9001ZM13.9001 8.97418C13.9001 10.0656 13.5144 11.0465 12.8187 11.7404L12.9599 11.882C13.6973 11.1465 14.1001 10.1127 14.1001 8.97418H13.9001ZM12.8187 11.7404C12.1953 12.3614 11.3871 12.6908 10.478 12.6908V12.8908C11.4384 12.8908 12.2978 12.5416 12.9599 11.8821L12.8187 11.7404ZM10.478 12.6908H10.4683V12.8908H10.478V12.6908ZM10.4683 12.6908H4.53178V12.8908H10.4683V12.6908ZM4.53178 12.6908H4.52029V12.8908H4.53178V12.6908Z"
                                                              fill="#4B535A"/>
                                                    </svg> <?php echo esc_html( $paradise_htb_mail_id ); ?></a>
                                            </li>
										<?php endif; ?>
										<?php if ( ! empty( $paradise_htb_address ) ): ?>
                                            <li>
                                                <a href="<?php echo esc_html( $paradise_htb_address_url ); ?>" target="_blank">
													...
													<?php echo esc_html( $paradise_htb_address ); ?></a>
                                            </li>
										<?php endif; ?>
                                    </ul>
                                </div>
                            ...
                            <div class="col-xxl-6 col-xl-4 col-lg-4 col-md-4">
                                <div class="header__top-right d-flex justify-content-end align-items-center">
									<?php if ( ! empty( $paradise_htb_acc_button_text ) ): ?>
                                        <div class="header__login">
                                            <a href="<?php echo esc_html( $paradise_htb_acc_button_link ); ?>">
                                                ...
                                                </svg> <?php echo esc_html( $paradise_htb_acc_button_text ); ?></a>
                                        </div>
									<?php endif; ?>

									<?php if ( ! empty( $paradise_htb_button_text ) ): ?>
                                        <div class="header__btn ml-20">
                                            <a href="<?php echo esc_html( $paradise_htb_button_link ); ?>" class="header-btn"><?php echo esc_html( $paradise_htb_button_text ); ?></a>
                                        </div>
									<?php endif; ?>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 col-6">
                            <div class="logo">
								<?php paradise_htb_header_logo(); ?>
                            </div>
                        </div>
                        <div class="<?php echo esc_attr( $paradise_htb_menu_col ); ?>">
                            <div class="main-menu">
                                <nav id="mobile-menu">
									<?php paradise_htb_header_menu(); ?>
                                </nav>
                            </div>
                        </div>
						<?php if ( ! empty( $paradise_htb_header_right ) ): ?>
                            <div class="col-xxl-3 col-xl-3 col-lg-2 col-md-6 col-6">
                                <div class="header__bottom-right d-flex justify-content-end align-items-center pl-30">
                                    <div class="header__search w-100 d-none d-xl-block">
                                        <form action="<?php print esc_url( home_url( '/' ) ); ?>">
                                            <div class="header__search-input">
                                                <input type="text" name="s" value="<?php print esc_attr( get_search_query() ) ?>" placeholder="<?php print esc_attr__( 'Search...', 'paradise_htb' ); ?>">
    ...
    <header id="masthead" class="site-header reveal_header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-6">
                    <a href="<?php home_url( '/' ); ?>" class="logo_normal"><img src="<?php echo get_template_directory_uri(); ?> /assets/img/logo.png" width="135" height="45" alt=""></a>
                    <a href="<?php home_url( '/' ); ?>" class="logo_sticky"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_sticky.png" width="135" height="45" alt=""></a>
                </div>
                <div class="col-6">
                    <nav>
                        <ul>
                            <li><a href="index-2.html#booking_section" class="btn_1 btn_scrollto">Book Now</a></li>
                            <li>
    ...
    <div class="nav_panel">
        ...
        <div class="logo_panel"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_sticky.png" width="135" height="45" alt=""></div>
        <div class="sidebar-navigation">
            <!--            <nav>-->
            <!--                <ul class="level-1">-->
            <!--                    <li class="parent"><a href="index-2.html#0">Home</a>-->
            <!--                        <ul class="level-2">-->
            <!--                            <li class="back"><a href="index-2.html#0">Back</a></li>-->
            ...
            <!--                        </ul>-->
            <!--                    </li>-->
            <!--                    <li class="parent"><a href="index-2.html#0">Rooms & Suites</a>-->
            <!--                        <ul class="level-2">-->
            <!--                            <li class="back"><a href="index-2.html#0">Back</a></li>-->
            ...
            <!--                    <li class="parent"><a href="index-2.html#0">Other Pages</a>-->
            <!--                        <ul class="level-2">-->
            <!--                            <li class="back"><a href="index-2.html#0">Back</a></li>-->
            ...
            <!--                        </ul>-->
            <!--                    </li>-->
            <!--                    <li class="parent"><a href="index-2.html#0">Menu Versions</a>-->
            <!--                        <ul class="level-2">-->
            <!--                            <li class="back"><a href="index-2.html#0">Back</a></li>-->
            ...
            <nav>
				...
				wp_nav_menu(
					array(
						...
						'menu_class'     => 'paradise-menu level-1',
					)
				);
				?>
                <div class="panel_footer">
